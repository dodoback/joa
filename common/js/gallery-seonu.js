   const photos = [
      { src: "../images/seonu/1.png", desc: "볼륨 매직 시술" },
      { src: "../images/seonu/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/seonu/3.png", desc: "볼륨 매직 시술" },
      { src: "../images/seonu/4.png", desc: "레이어드 C컬펌" },
      { src: "../images/seonu/4.png", desc: "볼륨 매직 시술" },
      { src: "../images/seonu/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/seonu/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/seonu/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/seonu/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/seonu/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/seonu/1.png", desc: "볼륨 매직 시술" },
