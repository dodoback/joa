   const photos = [
      { src: "../images/yeli/1.png", desc: "볼륨 매직 시술" },
      { src: "../images/yeli/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/yeli/3.png", desc: "볼륨 매직 시술" },
      { src: "../images/yeli/4.png", desc: "레이어드 C컬펌" },
      { src: "../images/yeli/4.png", desc: "볼륨 매직 시술" },
      { src: "../images/yeli/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/yeli/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/yeli/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/yeli/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/yeli/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/yeli/1.png", desc: "볼륨 매직 시술" },
