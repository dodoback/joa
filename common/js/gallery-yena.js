   const photos = [
      { src: "../images/yena/1.png", desc: "볼륨 매직 시술" },
      { src: "../images/yena/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/yena/3.png", desc: "볼륨 매직 시술" },
      { src: "../images/yena/4.png", desc: "레이어드 C컬펌" },
      { src: "../images/yena/4.png", desc: "볼륨 매직 시술" },
      { src: "../images/yena/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/yena/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/yena/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/yena/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/yena/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/yena/1.png", desc: "볼륨 매직 시술" },
