   const photos = [
      { src: "../images/suin/1.png", desc: "볼륨 매직 시술" },
      { src: "../images/suin/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/suin/3.png", desc: "볼륨 매직 시술" },
      { src: "../images/suin/4.png", desc: "레이어드 C컬펌" },
      { src: "../images/suin/4.png", desc: "볼륨 매직 시술" },
      { src: "../images/suin/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/suin/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/suin/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/suin/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/suin/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/suin/1.png", desc: "볼륨 매직 시술" },
