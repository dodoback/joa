   const photos = [
      { src: "../images/hyelin/1.png", desc: "볼륨 매직 시술" },
      { src: "../images/hyelin/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/hyelin/3.png", desc: "볼륨 매직 시술" },
      { src: "../images/hyelin/4.png", desc: "레이어드 C컬펌" },
      { src: "../images/hyelin/4.png", desc: "볼륨 매직 시술" },
      { src: "../images/hyelin/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/hyelin/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/hyelin/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/hyelin/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/hyelin/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/hyelin/1.png", desc: "볼륨 매직 시술" },
