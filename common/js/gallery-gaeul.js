   const photos = [
      { src: "../images/gaeul/1.png", desc: "볼륨 매직 시술" },
      { src: "../images/gaeul/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/gaeul/3.png", desc: "볼륨 매직 시술" },
      { src: "../images/gaeul/4.png", desc: "레이어드 C컬펌" },
      { src: "../images/gaeul/4.png", desc: "볼륨 매직 시술" },
      { src: "../images/gaeul/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/gaeul/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/gaeul/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/gaeul/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/gaeul/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/gaeul/1.png", desc: "볼륨 매직 시술" },
