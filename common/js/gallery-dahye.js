   const photos = [
      { src: "../images/dahye/1.png", desc: "볼륨 매직 시술" },
      { src: "../images/dahye/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/dahye/3.png", desc: "볼륨 매직 시술" },
      { src: "../images/dahye/4.png", desc: "레이어드 C컬펌" },
      { src: "../images/dahye/4.png", desc: "볼륨 매직 시술" },
      { src: "../images/dahye/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/dahye/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/dahye/2.png", desc: "레이어드 C컬펌" },
      { src: "../images/dahye/2.png", desc: "볼륨 매직 시술" },
      { src: "../images/dahye/1.png", desc: "레이어드 C컬펌" },
      { src: "../images/dahye/1.png", desc: "볼륨 매직 시술" },
